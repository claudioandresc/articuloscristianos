...
{	$conn_id = ftp_connect("articuloscristianos.com");
	$login_result = ftp_login($conn_id,"articul2","8KLPi0ilp6"); 				
...
function existe_email($Email) {
	$buscar_nombre = mysql_query("SELECT * FROM usuarios WHERE email='$Email'");
