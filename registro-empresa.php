  ...
  <tr>
	...
	<form id="registroForm" name="registroForm" method="post" action="?<?=$action?>" enctype="multipart/form-data">
	  ...
	  <table width="700" border="0" align="center" cellpadding="4" cellspacing="0">
	    <? if ($_SESSION['shalom']=="") { ?>
        <tr>
          <td colspan="2" align="center" valign="middle" class="txt-reg" style="padding-bottom:15px;"><div class="reg-box">Para registrarse como <strong>Persona Natural</strong>, haga <a href="registro.php" style="font-weight:bold; color:#CC0000;">click aqu&iacute;</a></div></td>
	    </tr>
        <? } ?>
        <tr>
          <td width="255" align="right"><span class="txt-white-bold-2">*</span> Nombre de la Empresa:</td>
        ...
        <tr>
          <td align="right"><span class="txt-white-bold-2">*</span> &Aacute;rea o Rubro a que se dedica:</td>
        ...
        <tr>
          <td align="right"><span class="txt-white-bold-2">*</span> RIF&nbsp; &oacute; &nbsp;N&deg; de Registro:</td>
          <td valign="top" class="txt-error-msg"><input name="cedula" type="text" class="fields-txt2 required" id="cedula" value="<?=$d['cedula']?>" /></td>
        </tr>
        <tr>
          <td align="right"><span class="txt-white-bold-2">*</span> Fecha de Constituci&oacute;n:</td>
        ...
        <tr>
          <td align="right"> Otro Tel&eacute;fono &oacute; Fax:</td>
        ...
        <tr>
          <td align="right"><span class="txt-white-bold-2">*</span> Pa&iacute;s de Ubicaci&oacute;n:</td>
        ...
        <tr>
          ...
          <td valign="top" class="txt-error-msg"><input name="ciudad" type="text" class="fields-txt2 required" id="ciudad" style="text-transform:capitalize" value="<?=$d['ciudad']?>" /></td>
        </tr>
        <tr>
          <td align="right" valign="top" style="line-height:14px;"><span class="txt-white-bold-2">*</span> Direcci&oacute;n f&iacute;sica:<br />
